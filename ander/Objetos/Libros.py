...
if __name__=='__main__':    
    ...
    libro2 = Libro('La Guia del Ligue', 'Werevertumorro', 'Terror analogico', 1666)
    ...
    titulo_buscado = input('Ingresa el libro a buscar owo (Respetar mayusculas): ')
    ...
    titulo_a_eliminar = input('Ingresa algun titulo para eliminar de la biblioteca: ')
